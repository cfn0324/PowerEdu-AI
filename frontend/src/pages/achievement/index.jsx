...
const Achievement = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // 并行加载数据
      const [summaryRes, leaderboardRes, pointsRes] = await Promise.all([
    ...
    <Row gutter={[16, 16]}>
      <Col xs={12} sm={6}>
        <Card>
          <Statistic
            title="学习时长"
            value={Math.floor(summaryData.stats.total_study_time / 60)}
            suffix="小时"
      ...
      <Col xs={12} sm={6}>
        <Card>
          <Statistic
            title="完成课程"
            value={summaryData.stats.completed_courses}
            suffix="门"
      ...
      <Col xs={12} sm={6}>
        <Card>
          <Statistic
            title="连续学习"
            value={summaryData.stats.continuous_days}
            suffix="天"
            prefix={<FireOutlined />}
      ...
      <Col xs={12} sm={6}>
        <Card>
          <Statistic
            title="总积分"
            value={summaryData.stats.total_points}
            prefix={<StarOutlined />}
  ...
  return (
    <div className="achievement-page" style={{ padding: '20px' }}>
      <h2 style={{ marginBottom: '20px', color: '#0a2d5f' }}>
